    ...
    if existing is not None:
        ...
        try:
            ...
            if recovered is not None:
                # Startup-ok / receipt lost: reuse by stable attempt id.
...
def _persist_unconfirmable_attempt(
    state: AgentState,
    hyp: Hypothesis,
    *,
    experiment_id: str,
    ...
    """Write explicit Week-1 insufficient_evidence when completion is unconfirmable."""
...
def _benchmark_unconfirmed_failure(
    ...
    *,
    ...
    if is_ack_lost(exc):
        ...
        incomplete = _persist_unconfirmable_attempt(
